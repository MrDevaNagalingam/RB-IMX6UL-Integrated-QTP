"""Host UART lifecycle and BOSCHcompatible V2 framing."""
import uuid

import struct
import time

#Active V2 format. Kept here to preserve the requested module layout.
...
class UARTCommunicator:
    ...
    def send_and_receive(self, command, params=None, output_callback=None):
        ...
        # Type 3 is an RB correlation extension; types 1/2 retain BOSCH meanings.
